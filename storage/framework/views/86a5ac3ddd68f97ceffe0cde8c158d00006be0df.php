<?php $__env->startSection('content_add_form'); ?>
    ...
    <div class="form-group<?php echo e($errors->has('city_slug') ? ' has-error' : ''); ?>">
        <label for="city_slug" class="col-md-2 pull-right control-label">کلمات کلیدی آدرس:</label>
        <div class="col-md-6 pull-right">
            <input type="text" class="form-control" name="city_slug" value="<?php echo e(old('city_slug',isset($city->city_slug) ? $city->city_slug : '')); ?>">
            <?php if($errors->has('city_slug')): ?>
                <span class="help-block"><strong><?php echo e($errors->first('city_slug')); ?></strong></span>
            <?php endif; ?>
        </div>
    </div>
