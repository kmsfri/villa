<?php $__env->startSection('content_list'); ?>
    ...
    <tr>
        ...
        <th scope="col" class="text-center">کد مطلب</th>
    ...
    <?php $__currentLoopData = $comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            ...
            <td class="text-center">
                <p class="text"><?php echo e(isset($cm->mobile_number)?$cm->mobile_number:$cm->RenterUser()->first()->mobile_number); ?></p>
            </td>
            <td class="text-center">
                <p class="text"><?php echo e($cm->content_id); ?></p>
            </td>
            <td class="text-center">
            ...
            <td class="text-center">
                <p class="situation <?php echo e(($cm->comment_status==1)?'active':''); ?>">
                    <?php echo e(($cm->comment_status==1)?'فعال':'غیرفعال'); ?>

                </p>
            </td>
            <td class="text-center"><a href="<?php echo e(Route('editContentComment',$cm->id)); ?>">مشاهده</a></td>
        </tr>
