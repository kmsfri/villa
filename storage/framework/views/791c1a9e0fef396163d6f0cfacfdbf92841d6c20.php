        ...
        <tr>
            ...
            <td class="text-center">
                ...
                <?php if($content->show_in_body != 0): ?>
                    <a href="<?php echo e(route('adminShowinBody',$content->id)); ?>" data-toggle="tooltip" title="نمایش در بالای بلاگ"><i class="fa fa-eye"></i></a>
                <?php else: ?>
                    <a href="<?php echo e(route('adminShowinBody',$content->id)); ?>" data-toggle="tooltip" title="عدم نمایش در بالای بلاگ"><i class="fa fa-eye-slash"></i></a>
                <?php endif; ?>
            </td>
