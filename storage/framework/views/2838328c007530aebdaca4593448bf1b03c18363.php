            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a href="<?php echo e(Route('adminVillaTypeList')); ?>">نوع ویلا</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    <a class="" href="<?php echo e(url(Route('adminTicketList'))); ?>"><i class="fa fa-book fa-fw"></i>تیکت ها</a>
                </li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a href="<?php echo e(Route('adminContentCommentList')); ?>">نظرات مطالب</a>
                        </li>
                        <li>
                            <a href="<?php echo e(Route('adminWebsiteCommentList')); ?>">نظرات وبسایت</a>
                        </li>
