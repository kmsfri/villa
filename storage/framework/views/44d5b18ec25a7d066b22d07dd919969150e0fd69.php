    ...
    <div class="form-group<?php echo e($errors->has('comment_status') ? ' has-error' : ''); ?>">
        ...
        <div class="col-md-6 pull-right">
            <select  name='comment_status' class='selectpicker form-control pull-right' autocomplete="off">
                <option <?php if(old('comment_status' , isset($comment->comment_status) ? $comment->comment_status : '')==0): ?> selected <?php endif; ?> value="0" >غیرفعال</option>
                <option <?php if(old('comment_status' ,isset($comment->comment_status) ? $comment->comment_status : '' )==1): ?> selected <?php endif; ?> value="1" >فعال</option>
            </select>
