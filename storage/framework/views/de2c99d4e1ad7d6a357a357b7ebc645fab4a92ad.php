    ...
    <div class="box-panel">
        ...
        <div class="data">
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <textarea class="form-control" name="content_short_desc"><?php echo e(old('content_short_desc',isset($content->content_short_desc) ? Helpers::br2nl($content->content_short_desc) : '')); ?></textarea>
...
<?php $__env->startSection('jsCustom'); ?>
    ...
    <script>
        CKEDITOR.replace('cktext' , {
            filebrowserImageBrowseUrl  : '<?php echo e(asset('admin/ckeditor/kcfinder/browse.php?opener=ckeditor&type=images&langCode=fa')); ?>',
