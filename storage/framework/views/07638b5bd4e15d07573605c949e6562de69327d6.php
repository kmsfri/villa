    ...
    <main>
      <aside class="sidebar">
        ...
        <ul class="ul-sidebar">
          ...
          <li><a href="" title=""><img src="<?php echo e(asset('users/img/icon/icon043.png')); ?>" alt=""><img class="img" src="<?php echo e(asset('users/img/icon/icon043-2.png')); ?>" alt=""><span>گردشگری</span></a></li>
          <li><a href="" title=""><img src="<?php echo e(asset('users/img/icon/icon045.png')); ?>" alt=""><img class="img" src="<?php echo e(asset('users/img/icon/icon045-2.png')); ?>" alt=""><span>وبلاگ من</span></a></li>
          <li><a href="<?php echo e(route('blogaction')); ?>" title=""><img src="<?php echo e(asset('users/img/icon/icon044.png')); ?>" alt=""><img class="img" src="<?php echo e(asset('users/img/icon/icon044-2.png')); ?>" alt=""><span>پیام ها</span></a></li>
