            ...
            <div class="row justify-content-sm-center">
                ...
                @foreach($villas as $villa)
                    <div class="col-sm-6 col-md-6 col-lg-3">
                        ...
                        <article class="vila">
                            <figure><img src="{{asset($villa->VillaImages()->orderBy('image_order','ASC')->first()->image_dir)}}" alt="{{$villa->villa_title}}"/><a class="estate" href="" title="{{$villa->villa_title}}">مشاهده ملک</a><a class="heart" href=""><i class="fa fa-heart-o"></i></a></figure>
                            <div class="data">
