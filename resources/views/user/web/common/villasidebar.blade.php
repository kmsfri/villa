<div class="col-md-5 col-lg-4 sticky-vila">
    <aside class="theiaStickySidebar">
        ...
        <div class="box-price d-none d-md-inline-block">
            <form class="search" method="post" action="{{route('reserve_request',$villa->id)}}">
                {{csrf_field()}}
                <div class="form-group width">
                    ...
                    <div class="width">
                        <input class="form-control datepicker" name="date_in" type="text" value="{{old('date_in')}}" placeholder="تاریخ ورود" required>
                        <input class="form-control datepicker" name="date_out" type="text" value="{{old('date_out')}}" placeholder="تاریخ خروج" required>
                    </div>
                </div>
                ...
                <div class="form-group name">
                    ...
                    <input class="form-control" type="text" name="fullname" value="{{old('fullname')}}" placeholder="نام و نام خانوادگی" required>
                </div>
                <div class="form-group contact">
                    <label>شماره تماس</label>
                    <input class="form-control" type="tel" name="phone" value="{{old('phone')}}" placeholder="شماره تماس- مثال(0912000000)" required>
                </div>
