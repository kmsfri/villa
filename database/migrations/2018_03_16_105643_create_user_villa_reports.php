...
class CreateUserVillaReports extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_villa_reports', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('report_text',280);
            $table->boolean('report_status')->default(0)->comment='0:disable - 1:active';
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('user_villa_reports');
    }
}
